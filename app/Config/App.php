...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    public string $baseURL =  'http://localhost/ci4-starter-user-crud/public/';//'http://localhost:8080/';
     ...
     * secure, the users will be redirected to a secure version of the page
