...
<div class="col-md-8 order-md-1">
    ...
    <form method="post" action="<?= base_url('user/update/'.$user['id']); ?>" class="needs-validation" novalidate>
        <div class="row">
        ...
        <div class="mb-3">
            ...
            <input type="password" class="form-control" name="password" id="password"  placeholder="Reset Password ONLY" value="">
        </div>
